...
- Owner-scoped tracking snapshots support saved jobs, applied, recruiter contact, phone screen, interview, assignment, final interview, offer, rejected, and withdrawn stages with bounded private notes and latest-update timestamps. “Sent résumé” maps to applied without discarding existing notes. Closed job postings remain in history with an unavailable label.
